...
namespace Nop.Plugin.Widgets.FacebookPixel.Services
{
    ...
    ";
        ...
        public FacebookPixelConfiguration GetConfigurationById(int configurationId)
        {
            ...
            return _cacheManager.Get(_cacheKeyService.PrepareKeyForDefaultCache(FacebookPixelDefaults.ConfigurationCacheKey, configurationId), () =>
        ...
        public void InsertConfiguration(FacebookPixelConfiguration configuration)
        {
            ...
            _cacheManager.RemoveByPrefix(FacebookPixelDefaults.PrefixCacheKey);
        }
        ...
        {
            var cachedCustomEvents = _cacheManager.Get(_cacheKeyService.PrepareKeyForDefaultCache(FacebookPixelDefaults.CustomEventsCacheKey, configurationId), () =>
            {
        ...
        {
            return _cacheManager.Get(FacebookPixelDefaults.WidgetZonesCacheKey, () =>
            {
